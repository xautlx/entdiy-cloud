package com.entdiy.common.datascope.aspect;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.entdiy.common.datascope.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, LoginUser user, String deptAlias, String userAlias) {
        ...
        for (LoginUser.RoleVO role : user.getRoleVOs()) {
