package com.entdiy.common.security.aspect;

import com.entdiy.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(com.entdiy.common.security.annotation.PreAuthorize)")
