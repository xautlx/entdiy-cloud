package com.entdiy.common.redis;

import com.entdiy.common.redis.service.RedisService;
import com.entdiy.common.redis.service.RedisTokenService;
        ...
        try {
            ...
            if (log.isInfoEnabled()) {
                if (StringUtils.isNotEmpty(redisProperties.getUrl())) {
                    log.info("Redis init connection success: {}", redisProperties.getUrl());
                } else {
                    log.info("Redis init connection success: {}:{}/{}", redisProperties.getHost(), redisProperties.getPort(), redisProperties.getDatabase());
                }
            }
