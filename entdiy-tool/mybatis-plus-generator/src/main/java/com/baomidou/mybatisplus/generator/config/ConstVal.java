...
public interface ConstVal {
    ...
    String TEMPLATE_DTO_SEARCH = "/templates/dtoSearch.java";
    String TEMPLATE_DTO_LIST = "/templates/dtoList.java";
    String TEMPLATE_DTO_EDIT = "/templates/dtoEdit.java";
    String TEMPLATE_MAPSTRUCT_MAPPER_DTO_LIST = "/templates/mapstructListDtoMapper.java";
    String TEMPLATE_MAPSTRUCT_MAPPER_DTO_EDIT = "/templates/mapstructEditDtoMapper.java";
