...
import com.baomidou.mybatisplus.generator.config.ITypeConvert2;
 ...
 * @since 2017-01-20
 */
public class MySqlTypeConvert2 implements ITypeConvert2 {
    ...
    public IColumnType processTypeConvert(GlobalConfig globalConfig, TableField tableField) {
        ...
        if (t.contains("char(1)") && fname.startsWith("is_")) {
