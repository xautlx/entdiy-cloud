        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if (null != entityName && null != pathInfo.get(ConstVal.ENTITY_PATH)) {
                    ...
                    String dtoSearchFile = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "%s" + suffixJavaOrKt()), entityName + "SearchDto");
                    if (isCreate(FileType.DTO, dtoSearchFile)) {
                        writer(objectMap, templateFilePath(template.getDtoSearch()), dtoSearchFile);
                    }
