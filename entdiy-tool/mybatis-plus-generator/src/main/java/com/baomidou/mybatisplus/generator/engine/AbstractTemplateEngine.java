...
public abstract class AbstractTemplateEngine {
        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if (null != entityName && null != pathInfo.get(ConstVal.ENTITY_PATH)) {
                    ...
                    String dtoListFile = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "%s" + suffixJavaOrKt()), entityName + "ListDto");
                    if (isCreate(FileType.DTO, dtoListFile)) {
                        writer(objectMap, templateFilePath(template.getDtoList()), dtoListFile);
                    }
                    String dtoEditFile = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "%s" + suffixJavaOrKt()), entityName + "EditDto");
                    if (isCreate(FileType.DTO, dtoEditFile)) {
                        writer(objectMap, templateFilePath(template.getDtoEdit()), dtoEditFile);
                    }

                    String dtoListMapperFile = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "mapper" + File.separator + "%s" + suffixJavaOrKt()), entityName + "ListDtoMapper");
                    if (isCreate(FileType.DTO, dtoListMapperFile)) {
                        writer(objectMap, templateFilePath(template.getMapstructListDtoMapper()), dtoListMapperFile);
                    }
                    String dtoEditMapperFile = String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "mapper" + File.separator + "%s" + suffixJavaOrKt()), entityName + "EditDtoMapper");
                    if (isCreate(FileType.DTO, dtoEditMapperFile)) {
                        writer(objectMap, templateFilePath(template.getMapstructEditDtoMapper()), dtoEditMapperFile);
                    }
                }
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superEntityClass", getSuperClassName(tableInfo.getSuperEntityClass()));
        objectMap.put("superListDtoClass", getSuperClassName(tableInfo.getSuperListDtoClass()));
        objectMap.put("superEditDtoClass", getSuperClassName(tableInfo.getSuperEditDtoClass()));
        ...
        objectMap.put("superModelMapperClassPackage", config.getStrategyConfig().getSuperModelMapperClass());
        objectMap.put("superModelMapperClass", getSuperClassName(config.getStrategyConfig().getSuperModelMapperClass()));
