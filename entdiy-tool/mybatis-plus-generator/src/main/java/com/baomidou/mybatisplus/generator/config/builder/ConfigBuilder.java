...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getDtoSearch(), outputDir, ConstVal.DTO_PATH, ConstVal.DTO);
        ...
        try {
            ...
            try (
                ...
                while (results.next()) {
                    ...
                    field.setColumnType(dataSourceConfig.getTypeConvert2().processTypeConvert(globalConfig, field));
                    if (commentSupported) {
