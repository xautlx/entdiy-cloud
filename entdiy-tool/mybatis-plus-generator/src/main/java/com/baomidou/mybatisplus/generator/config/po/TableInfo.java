...
public class TableInfo {
    ...
    private String superListDtoClass;
    private final Set<String> importListDtoPackages = new HashSet<>();
    private String superEditDtoClass;
    private final Set<String> importEditDtoPackages = new HashSet<>();
